          ...
          <TabsContent value="timeline" className="space-y-6">
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  A reactive timeline using <code>useTimeline</code> hook with Note casts.
              ...
              <CardContent>
                <div className="mb-4 p-4 bg-muted rounded-lg text-sm">
                  ...
                  <ul className="list-disc list-inside space-y-1 text-muted-foreground">
                    <li>Reactive timeline with <code>useTimeline</code></li>
                    <li>Note casts with reactive properties</li>
                    <li>Author profiles with <code>use$(note.author.profile$)</code></li>
                    <li>Reply-to detection with <code>use$(note.replyingTo$)</code></li>
          ...
          <TabsContent value="profile" className="space-y-6">
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  User profile using <code>useProfile</code> hook with ProfileModel.
                  Reactively updates when profile metadata changes.
                </CardDescription>
              </CardHeader>
              <CardContent>
                <div className="mb-4 p-4 bg-muted rounded-lg text-sm">
                  <p className="font-semibold mb-2">Features demonstrated:</p>
                  <ul className="list-disc list-inside space-y-1 text-muted-foreground">
                    <li>Profile loading with <code>useProfile(pubkey)</code></li>
                    <li>ProfileModel reactive subscription</li>
                    <li>All NIP-01 metadata fields (name, picture, banner, about, etc.)</li>
          ...
          <TabsContent value="info" className="space-y-6">
            <Card>
              ...
              <CardContent className="prose prose-sm dark:prose-invert max-w-none">
                ...
                <p>
                  Applesauce is a production-ready Nostr SDK built on RxJS observables,
                  used in production by noStrudel. It follows a store-first architecture:
                </p>

                <ol>
                  <li><strong>EventStore</strong> - Central state container for all events</li>
                  <li><strong>RelayPool</strong> - Manages WebSocket connections to relays</li>
                  <li><strong>Loaders</strong> - Automatically batch and cache event requests</li>
                  <li><strong>Models</strong> - Reactive data models (ProfileModel, ThreadModel, etc.)</li>
                  <li><strong>Casts</strong> - Object-oriented event wrappers with reactive properties</li>
                  <li><strong>Actions</strong> - Pre-built operations for common tasks</li>
                  <li><strong>Accounts</strong> - Multi-account management with various signers</li>
                </ol>

                <h3>Key Benefits</h3>
                <ul>
                  <li><strong>Reactive</strong> - Automatic updates via RxJS observables</li>
                  <li><strong>Efficient</strong> - Request batching, deduplication, caching</li>
                  <li><strong>Type-safe</strong> - Full TypeScript support</li>
                  <li><strong>Feature-rich</strong> - Comprehensive NIP support</li>
                  <li><strong>Production-ready</strong> - Battle-tested in noStrudel</li>
                </ul>

                <h3>Learn More</h3>
                <p>
                  Check out the <code>/src/hooks</code> directory for hook implementations,
                  and <code>/src/services</code> for the core architecture setup.
                </p>
              </CardContent>
            </Card>
          </TabsContent>
